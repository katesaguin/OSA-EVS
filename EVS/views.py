...
def tallyDetails_views(request):
...
def settingsAcademicYear_view(request):
    return render(request, 'system/settings-academic-year.html', {'active_page': 'academic-year'})

def settingsUserManagement_view(request):
    return render(request, 'system/settings-user-management.html', {'active_page': 'user-management'})
